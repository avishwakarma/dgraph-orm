...
var Model = /** @class */ (function () {
    ...
    Model.prototype.update = function (data, uid) {
        return __awaiter(this, void 0, void 0, function () {
            var _keys, mutation, _delete, _key, data_1, _uids;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        mutation = this._parse_mutation(data, this.schema.name);
                        _delete = null;
                        Object.keys(data).forEach(function (_key) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_b) {
                                _delete = {};
     ...
     * @returs void
     */
    Model.prototype._check_attributes = function (original, attributes, isUpdate, isRelation) {
